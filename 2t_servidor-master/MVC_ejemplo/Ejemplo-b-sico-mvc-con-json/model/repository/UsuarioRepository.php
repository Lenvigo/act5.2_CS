...
class UsuarioRepository implements IUsuarioRepository {
    ...
    const RUTA_FICHERO =CONFIG_FOLDER . DIRECTORY_SEPARATOR . "usuario.json";
    ...
    public function __construct() {
        ...
        // L: intentar comprender las siguientes lineas de codigo: coge un objeto fichero json y lo guarda en un array en memoria que es propiedad de esta clase, es un array asociativo de objetos nota. Solo se le llama una vez en el constructor.

        //Se lee el fichero .json como array asociativo
        $arrayAsoc = json_decode(file_get_contents($this->filePath), true);// si no le pasamos el true generara objetos. al ponerle true crea una array asociativo
