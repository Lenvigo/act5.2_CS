...
final class Profesor extends Persoa
{
    ...
    // en el caso de no usar use clases\items\Baile deberiamos ponerlo cadavez que aparece un objeto de esa clase;
    //public function engadir(\clases\items\Baile $baile): bool
