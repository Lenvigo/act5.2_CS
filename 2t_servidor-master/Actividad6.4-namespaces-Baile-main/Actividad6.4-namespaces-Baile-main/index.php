...
$fecha = new DateTimeImmutable("1998-12-12");
$alumno1 = new Alumno("Juan", "Antas Ulla", "650650650",$fecha);
$alumno2 = new Alumno("Rita", "Román Rueda", "652652652",new DateTimeImmutable("2008-11-5"));
...
echo "<pre>";
//JSON_PRETTY_PRINT para ponerlo bonito
//JSON_UNESCAPED_UNICODE para poner acentos
